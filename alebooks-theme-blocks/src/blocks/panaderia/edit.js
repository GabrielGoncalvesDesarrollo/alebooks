...
import { PanelBody, Icon, PanelRow, Button, ColorPalette, TextControl, Toolbar, ToolbarButton, TextareaControl } from '@wordpress/components';
...
class BlockEdit extends Component {
	...
	render(){
		...
		const { cardTitle, cardDirection, imageAlt, imageUrl, coverColor, coverColorName, post } = attributes;
		...
		return(
			<Fragment>
				<InspectorControls>
					...
					>
						...
						>
							...
							<TextareaControl
								label="Dirección"
								help="Introduzca la dirección de la panadería"
								value={cardDirection}
								onChange={(value) => {
									setAttributes({cardDirection: value})
								}}
							/>
						</PanelRow>
						...
						<PanelRow
							...
							header="Enlace"
						>
							<div className="card-label">Enlace de la tarjeta</div>
							<LinkControl
								label="Enlace"
				...
				<div className={`panaderia-card ${getColorName(coverColor)}`}>
					<div className="bg">
					...
					<div className="body">
						...
						<div className="flecha">
							...
							<svg width="46" height="34" viewBox="0 0 46 34" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M0 17H45.5" stroke="currentColor" stroke-width="2" />
								<path d="M46 17C40.3333 17 29 13.6 29 0" stroke="currentColor" stroke-width="2" />
								<path d="M29 34C29 28.3333 32.4 17 46 17" stroke="currentColor" stroke-width="2" />
							</svg>
						</div>
					</div>
				</div>
